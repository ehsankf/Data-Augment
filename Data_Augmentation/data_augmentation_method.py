...
class data_augmentation():
    ...
    def rotate (self, image, angle=30):
    ...
    def random_translation(self, image, max_shift):
        height, width = image.shape[:2]
    ...
    def scale_image(self, image, scale_percent_x, scale_percent_y):
...
def test():
    path = '/home/ehsan/PycharmProjects/data_augmentation/cropped_dataset_1000/Polybag/_351.png'
    ...
    x_scales = [50, 100,  150, 200,  250,  300]
    y_scales = [50, 100,  150, 200, 250,  300]
