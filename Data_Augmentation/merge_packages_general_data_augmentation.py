...
def data_engin(image_path, packages, background_path, aug_background, aug_package, image_id, object_id ,coco_data):
    ...
    number_packages_in_scene = 150
    json_address = '/media/ehsan/Bereket/SYNTHETIC_DATA_4/json_file/'
    ...
    for i in range(1, number_packages_in_scene):
        ...
        name_ = '/media/ehsan/Bereket/SYNTHETIC_DATA_4/synthetic_images/' + str(image_id) + '.png'
        cv2.imwrite(name_, back_img_save)
        annotated_name = '/media/ehsan/Bereket/SYNTHETIC_DATA_4/annotated_images/' + str(image_id) + '.png'
