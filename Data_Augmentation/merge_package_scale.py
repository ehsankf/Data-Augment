...
def transform(image, aug):
    ...
    x_scales = [75, 100,  150, 200,  250,  300, 350]
    y_scales = [75, 100,  150, 200, 250,  300, 350]
    transformed_image_list = [[]]
    for x_scale in x_scales:
        for y_scale in y_scales:
            out = aug.scale_image(image_cut, x_scale, y_scale)
            # plt.imshow(out)
            # plt.show()
    ...
    # print(len(transformed_image_list))
    # for image_out in transformed_image_list:
...
def data_engin(image_path, packages, background_path, aug_background, aug_package, image_id, object_id ,coco_data):
    ...
    for back_gr in backgrounds:
        ...
        image_input_list = transform(image_input, aug)
